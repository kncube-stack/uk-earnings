...
const userSalary = isWeekly ? weeklyPay : annualPay;
const setUserSalary = isWeekly ? setWeeklyPay : setAnnualPay;
const salary = parseFloat(userSalary.replace(/[\u00a3,\s]/g, “”)) || null;
...
? Math.ceil(scaleMax / 200) * 200 + 100
: Math.ceil(scaleMax / 10000) * 10000 + 5000;
